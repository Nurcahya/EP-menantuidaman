...
public class evolutionaryDecisionTree {
        ...
        public evolutionaryDecisionTree(String filename) throws FileNotFoundException {
            ...
            if (filename.contains("/data/monks")) {
                ...
                bacaData(true, scanner2);
            } else {
                bacaData(false, scanner);
                bagiData();
            }
            System.out.println("Membentuk Pohon");
            tree();
            report(this.tree);
            scanner.close();
        }

    private void bagiData() {
    ...
    private boolean checkTree(int terminus) {
      ...
      //  System.out.println("ukuran tree "+this.tree.size());
      //  System.out.println("ukuran terminus "+terminus);
    ...
    private void bacaData(boolean test, Scanner scan) {
        if (!test) {
    ...
    private int randomSplit(ArrayList<Node> set) {
       ...
       // System.out.println("randomnya : "+this.q.size());
